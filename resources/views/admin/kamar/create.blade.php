...
<div class="max-w-2xl mx-auto">
  ...
  <input name="kode_kamar" class="w-full border rounded px-3 py-2" required>
      </div>
      <div class="mb-3 grid grid-cols-2 gap-3">
        <div>
          <label class="block text-sm font-medium">Jenis Kamar</label>
          <input name="jenis_kamar" class="w-full border rounded px-3 py-2" required>
        </div>
        <div>
          <label class="block text-sm font-medium">Gedung</label>
          <input name="gedung" class="w-full border rounded px-3 py-2">
        </div>
      </div>
      <div class="mb-3">
        <label class="block text-sm font-medium">Harga (Rp)</label>
        <input name="harga" type="number" class="w-full border rounded px-3 py-2">
      </div>
      <div class="mb-3">
        <label class="block text-sm font-medium">Fasilitas</label>
        <input name="fasilitas" class="w-full border rounded px-3 py-2">
      </div>
      <div class="mb-3">
