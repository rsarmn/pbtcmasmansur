...
<body>
  ...
  <a id="back-top-right" href="<?php echo e(route('admin.dashboard')); ?>" class="btn-save" style="position:fixed;top:18px;right:18px;background:#6b7280;z-index:99999;padding:8px 12px;font-size:14px;box-shadow:0 6px 12px rgba(0,0,0,.12)">Kembali</a>
  ...
  <form id="form-beranda" action="<?php echo e(route('beranda.update', 1)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="grid-2">
      <div>
        <div class="input-row">
          ...
          <input type="text" id="instagram" name="instagram" value="<?php echo e($data->instagram); ?>" style="opacity: 0.5;">
        ...
        <div class="input-row">
          ...
          <input type="email" id="email" name="email" value="<?php echo e($data->email); ?>" style="opacity: 0.5;">
      ...
      <div>
        <div class="input-row">
          ...
          <input type="text" id="whatsapp" name="whatsapp" value="<?php echo e($data->whatsapp); ?>" style="opacity: 0.5;">
        ...
        <div class="input-row">
          ...
          <input type="text" id="location" name="location" value="<?php echo e($data->location); ?>" style="opacity: 0.5;">
    ...
    <div class="full-row">
      ...
      <input type="text" id="maps_link" name="maps_link" value="<?php echo e($data->maps_link); ?>" style="opacity: 0.5;">
    ...
    <!-- SLIDER 1 -->
    <h3>Slider 1</h3>
    <?php if($data->slider1_image): ?>
      <img src="<?php echo e(asset($data->slider1_image)); ?>" width="150">
    <?php endif; ?>
    <div class="slider-row">
      <label>Gambar Baru:</label>
      <input type="file" name="slider1_image" id="slider1_image">
      <label>Teks Slider 1:</label>
      <textarea name="slider1_text" rows="3" style="width: 100%;"><?php echo e($data->slider1_text); ?></textarea>
    ...
    <!-- SLIDER 2 -->
    <h3>Slider 2</h3>
    <?php if($data->slider2_image): ?>
      <img src="<?php echo e(asset($data->slider2_image)); ?>" width="150">
    <?php endif; ?>
    <div class="slider-row">
      <label>Gambar Baru:</label>
      <input type="file" name="slider2_image" id="slider2_image">
      <label>Teks Slider 2:</label>
      <textarea name="slider2_text" rows="3" style="width: 100%;"><?php echo e($data->slider2_text); ?></textarea>
...
<?php /**PATH C:\xampp\htdocs\peng\resources\views/beranda.blade.php ENDPATH**/ ?>