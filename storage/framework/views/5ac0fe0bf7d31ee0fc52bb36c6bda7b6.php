  ...
  <div class="login-wrap">
    <div class="panel-left">
      <div class="text-center">
        ...
        <img src="<?php echo e(asset('img/admin-page.png')); ?>" alt="admin" style="max-width:280px;width:100%">
      </div>
    </div>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\peng\resources\views/auth/login.blade.php ENDPATH**/ ?>